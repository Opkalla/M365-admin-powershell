...
Update-MgUser -UserId 'inviteduser_domain.com#EXT#@domain.onmicrosoft.com' -UsageLocation 'US'
...
$disabledPlans = $e5Sku.ServicePlans | Where-Object ServicePlanName -ne ("BI_AZURE_P2") | Select-Object -ExpandProperty ServicePlanId
